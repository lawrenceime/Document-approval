...
const Sorting = () => {
    ...
    const [selectOption, setSelectOption] = useState(SortOptions[0])
    return (
        <div className='lg:w-[186px] h-[47px] px-[12px] py-[i6px] border border-[#D9DBE9)] bg-[#FFF] rounded-[9px] mt-[41px] z-40'>
            ...
            {showDropdown && <ul className='lg:w-[212px] py-[19px] px-[21px] rounded-[5px] shadow-md space-y-[16px]  bg-[#FFF] z-40'>
                {SortOptions.map((option, index) => (<li key={index} onClick={() => {
